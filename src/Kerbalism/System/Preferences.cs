...
namespace KERBALISM
{
	...
	public class PreferencesStorm : GameParameters.CustomParameterNode
	{
		...
		public float _stormEjectionSpeedC = Settings.StormEjectionSpeed;
		...
		public float _stormRadiation = Settings.StormRadiation;
		...
		public float _externRadiation = Settings.ExternRadiation;
