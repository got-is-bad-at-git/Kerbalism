...
namespace KERBALISM
{
	public static class Cache
	{
		...
		public static void PurgeObjects(ProtoVessel v)
		{
			...
			DB.Vessel(v.vesselRef).InvalidateInfo();
		...
		/// <summary>
		/// TODO remove this method and replace all invocations. not doing this
		/// right now because that will touch every file, and there are other
		/// active branches
		/// </summary>
		public static Vessel_info VesselInfo(Vessel v)
		{
			return DB.Vessel(v).UpdateInfo(v);
		}
